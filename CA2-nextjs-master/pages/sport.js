...
const defaultNewsSource = 'TalkSport';
    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=TalkSport">Latest Sport News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=espn">ESPN</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=bbc-sport">BBC Sport</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=bleacher-report">Bleacher Report</a></li>
        </ul>
        ...
        <div>
          {this.state.articles.map((article, index) => (
            <section key={index}>
              ...
              <p><Link as={`/sport/${index}`} href={`/article?id=${index}`}><a>Read More</a></Link></p>
              {
                    this.state.showMe?
                      <div>
