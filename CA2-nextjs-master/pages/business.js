    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=rte">Latest Business News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=business-insider">Business Insider</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=financial-times">Financial Times</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=fortune">Fortune</a></li>
        </ul>
