// Brian McGrath - IT Management - X00120877
// The Irish News Buzz
    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=the-irish-times">Latest News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=cnn">CNN</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=bbc-news">BBC News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=independent">The Independant</a></li>
        </ul>
